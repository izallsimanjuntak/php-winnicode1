...
<head>
    ...
    <link rel="stylesheet" href="css/navcat.css">
...
<body>
    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #5271FF; font-size: 14px; padding: 5px 0; width: 100%;">
            <div class="container-fluid">
