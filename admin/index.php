...
<head>
    ...
    <!-- App title -->
    <title> Portal Berita Winni | Admin Login</title>
        ...
        <div class="container m-t-50">
            <div class="row align-items-center m-t-50">
                <div class="col-md-8 text-center">
                    <img src="assets/images/banner-logo.png" width="100%">
                </div>
                <div class="col-md-4 ">
                            ...
                            <div class="account-logo-box">
                                <h2 class="text-uppercase">
                                    <a href="index.php" class="text-success">
                                        <span><img src="assets/images/logo-winni-2x.png" alt="" width="350px"></span>
                                    </a>
                                </h2>
                                <p>Silahkan Log-in ke account anda dan mulai berpetualang</p>
                            </div>
                              <div class="account-content">
                                <form class="form-horizontal" method="post">
                                    ...
                                    <div class="text-right mb-2"><a href="forgot-password.php"><i class="mdi mdi-lock"></i> Lupa password?</a></div>
