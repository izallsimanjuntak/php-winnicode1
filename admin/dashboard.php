                ...
                <div class="col-md-4">
                    <div class="card-box h-100">
                        <div class="card-header">
                            ...
                            <span class="d-block mb-4 text-nowrap">Admin Winni Media</span>
                        </div>
                        <br><br>
                        ...
                        <div class="card-body">
                            <div class="row ">
                                <div class="col-md-6">
                                    <h1 class="display-6 text-primary mb-2 pt-4 pb-1">PT. Winni Code Garuda Teknologi</h1>
                                    <small class="d-block mb-3">In <br>Berita, informasi Magang, fest.</small>
                                    <br>
                                    <br>
                                    <a href="https://winnicode.com/" target="a_blank" class="btn btn-sm btn-primary">Visit Website</a>
                                </div>
                                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <div class="card-box h-100">
                        <div class="card-body">
                            <div class="row ">
                                <div class="card-header">
                                    <h4 class="card-title m-0">Pengunjung di 2024</h4>
                                </div>
                                <div id="chart">
